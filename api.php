...
add_action('onp_api_000_plugin_created', 'onp_api_000_plugin_created');
function onp_api_000_plugin_created( $plugin ) {
    $manager = new OnpApi000_Manager( $plugin );
    $plugin->api = $manager;
}
